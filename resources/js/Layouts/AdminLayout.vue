...
<template>
  <div>
    <div class="flex h-screen overflow-y-hidden bg-white @apply font-Musticapro">
      <!-- Loading screen -->
      <div
          v-if="loading"
      ...
      >
        ...
        <div class="flex items-center justify-between flex-shrink-0 p-2" :class="{'lg:justify-center': !isSidebarOpen}">
          <div class="flex flex-nowrap p-2 text-xl font-semibold leading-8 tracking-wider  whitespace-nowrap">
            <span><a :href="route('index')"><img class="w-10" src="/storage/icon/logo.webp" alt="main logo"></a></span>
            <span :class="{'lg:hidden': !isSidebarOpen}" class="self-end">Rtravel</span>
          </div>
        ...
        <div class="flex-shrink-0 p-2 border-t max-h-14">
          ...
          >
            ...
            <span :class="{'lg:hidden': !isSidebarOpen}"> {{ $t("exit") }} </span>
          </button>
        </div>
      </aside>
          ...
          <div class="flex items-center justify-between p-2">
            ...
            <div class="flex items-center space-x-3">
              <span class="p-2 text-xl font-semibold tracking-wider uppercase lg:hidden">
                <a :href="route('index')"><img class="w-24" src="/storage/icon/rtravel-Logo.svg" alt="main logo"></a>
              </span>
...
<!--                <div class="relative" >
              ...
              <!-- avatar button -->
              <div class="relative" >
                <button @click="isOpenPerfil = !isOpenPerfil" class="p-1 bg-gray-200 rounded-full focus:outline-none focus:ring">
                  <img
                ...
                >
                  ...
                  <ul class="flex flex-col p-2 my-2 space-y-1">
                    <li>
                      <a :href="route('profile.show')" class="block px-2 py-1 transition rounded-md hover:bg-gray-100">{{ $t("Profile") }}</a>
                    </li>
        ...
        <!-- Main footer -->
        <footer class="flex items-center justify-center gap-2 flex-shrink-0 p-4 border-t max-h-14 @apply font-Musticapro">
          <div>Rtravel &copy; 2024</div>
          <div class="text-sm">
            Made by
            <a
